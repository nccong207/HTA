...
namespace GiaThanh
{
    ...
    {
        // Constructors
        public updateGiaThanh(Database dbData, string MT, string DT,string MTid, string DTid, string GiaField, DateTime tungay, DateTime denngay, string ngayCtField)
        {
        ...
        private void updateMTDTCongthuc(string ChangedField)
        {
            ...
            {
                row1 = rowArray2[num1];
                str3 = row1["Formula"].ToString().ToUpper().Split(',')[0];
                list1 = this.getLstBien(row1["Formula"].ToString().Split(',')[0]);
                if (list1.Contains(ChangedField.ToUpper()))
                {
                    ...
                    if (newValue == this.dt)
                    {
                        ...
                        str0 = str0 + row1["fieldName"].ToString() + " = round(" + str3 + ",0) ";
                        str0 = str0 + text5;
                    }
                    else
                    {
            ...
            for (num1 = 0; num1 < rowArray2.Length; num1++)
            {
                ...
                if (list1.Contains(ChangedField.ToUpper()))
                {
                    this.updateMTDTCongthuc(row1["fieldName"].ToString().ToUpper().Split(',')[0]);
                }
            }
        }
